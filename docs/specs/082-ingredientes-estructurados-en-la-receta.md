...
- **Estado:** ✅ completada el 31 de agosto de 2026 (commit `b775a3c`), revisada por `revisor-specs` (tres rondas) y `revisor-codigo` (CUMPLE), probada por el usuario en producción.
- **Fecha:** 2026-08-31
