...
- **Estado:** 🚧 implementada y desplegada el 31 de agosto de 2026 (commit `b775a3c`), revisada por `revisor-specs` (tres rondas) y `revisor-codigo` (CUMPLE). **Pendiente de que el usuario la pruebe.**
- **Fecha:** 2026-08-31
